    ...
    if user_name and user_surname and user_email and user_gender and user_new_pass and user_con_pass:
        if user_new_pass == user_con_pass:
            if click_check_btn:
                ...
                conn = mysql.connector.connect(host='localhost',username='root',password='rohithk123',database = 'pro_data')
                #create database pro_data;
                #create table user_detail(user_names varchar(30),user_surnames varchar(30),user_emails varchar(50),user_dd int,user_mm varchar(30),user_yy int,user_passwords varchar(30),user_genders varchar(30));
...
def login_func(event=None):
    ...
    conn = mysql.connector.connect(host='localhost',username='root',password='anudeep',database = 'pro_data')
