...
table = pygame.image.load('scoreboard.png')
...
def message_display_medium(text, a, b, color):
    smalltext = pygame.font.Font('font.ttf', 60)
    textsurf, textrect = text_object(text, smalltext, color)
    textrect.center = (int(a), int(b))
    win.blit(textsurf, textrect)
    ...
    while True:
        for e in pygame.event.get():
            if e.type == pygame.QUIT:
                ...
                quit()
        win.blit(table, (0, 0))
        message_display_medium('Playername', 230, 61, black)
        message_display_medium('Score', 740, 61, black)
        x = [700, 700, 700, 700, 700, 700]
        y = [170, 170 + 112, 170 + 112 + 112, 170 + 112 + 112 + 112,
             170 + 112 + 112 + 112 + 112, 170 + 112 + 112 + 112 + 112 + 112]

        x1 = [190, 190, 190, 190, 190]
        y1 = [170, 170 + 117,  170 + 117 + 114,  170 +
              117 + 117 + 111, 170 + 117 + 117 + 111 + 111]
        xnew = []
        ynew = []
        xnew1 = []
        ynew1 = []
        ...
        for i in range(num_bullet - 1):
            ...
            if bulletx[i] <= 0:
                if i == 0:
                    ...
                    bullety[i] = random.randint(0, (i + 1) * 100)
                else:
                    bulletx[i] = random.randint(1000, 1500)
                    bullety[i] = random.randint(0, i * 100)
        # score for the game
        score += 1 / 100
        ...
        for i in range(num_bullet - 1):
            ...
            if bulletx[i] <= 0:
                if i == 0:
                    ...
                    bulletx[i] = random.randint(1000, 1500)
                    bullety[i] = random.randint(100, (i + 1) * 100)
        # score for the game
        score += 1 / 100
        # getting all the events in pygame window
        for events in pygame.event.get():
